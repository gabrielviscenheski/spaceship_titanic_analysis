# -*- coding: utf-8 -*-
"""spaceship_titanic_análise_inicial.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UVwNWLRdoqhkwN2bzgrCwli9nuUBvQyK

#**Spaceship Titanic:**

**Objetivo:**

Prever se passageiros foram transportados para dimensão alternativa durante a colisão do spaceship Titanic com uma anomalia no espaço tempo

**Métrica:** Acurácia

**Submissão:** Tabela com coluna PassengerId e Transported (True/False)

**Metadados:** retirados do Kaggle
...
**Modelo 1:**
*   Baixa porcentagem de valores nulos
    * "Age": subsituir por média, moda, mediana ou KNNImputer
    * Demais colunas: analisar a distribuição dos dados
...
"""---
**Overview da primeira tratativa:**

* Dataset inicial: 8693 linhas x 14 colunas
* Dataset final: 8693 linhas x 7 colunas
* Tratamento dos valores nulos:
    * Média: coluna "Age"
    * Mediana: demais colunas
----
